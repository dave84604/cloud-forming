...
var awssdk = require('aws.js')(args, cfg, c);
...
if( args.delete)
{
  console.log( "Use the del-stack utility to delet stacks");
  process.exit();
}
...
if( args.uat)
{
	sg.addSshIngress( tt_sg, "49.207.50.122/32");	
	sg.addSshIngress( tt_sg, "49.207.49.173/32");
	sg.addSshIngress( tt_sg, "106.51.133.94/32");
}
sg.addSshIngress( tt_sg, "3.8.147.28/32");	
